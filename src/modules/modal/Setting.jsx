...
const Setting = () => {
	...
	const handleCloseModal = React.useCallback(() => {
		dispatch(setIsOpenModalSetting(false));
		reset();
	}, [dispatch, reset]);
	useEffect(() => {
					...
					<form className=' grid modal__creat--job no_flex' onSubmit={handleSubmit(onSubmit)}>
						<div className='field col-12 md:col-12 grid'>
							<div className='field col-12 md:col-12'>
								<span htmlFor='exchange_rate'>
									Tỉ lệ chuyển đổi: <span className='warning'>*</span>
								</span>
							...
							<div className='field col-12 md:col-12 '>
								<span htmlFor='rate_sale'>
									Tỉ lệ hoa hồng ( SALER ): <span className='warning'>*</span>
								</span>
								<span className='p-float-label'>
									<InputNumber
										id='rate_sale'
