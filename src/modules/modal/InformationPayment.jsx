                        ...
                        <div className="field col-12 md:col-12 grid">
                            <div className="field col-12 md:col-6">
                                ...
                                <span className="p-float-label mt-3 flex cursor__normal">
                                    <span className='font-bold mt-1 pr-3 block'>{dataModalInformationPayment?.reminder_staff}</span>
                                </span>
                            </div>
                            <div className="field col-12 md:col-6">
                            ...
                            <div className="field col-12 md:col-6">
                                ...
                                <span className="p-float-label mt-3 flex cursor__normal">
                                    <span className='font-bold mt-1 pr-3 block'>{dataModalInformationPayment?.role}</span>
                                </span>
                            </div>
                            <div className="field col-12 md:col-6">
                                <span htmlFor="autocomplete">Tháng :</span>
                                <span className="p-float-label mt-3 flex cursor__normal">
                                    <span className='font-bold mt-1 pr-3 block'>{dataModalInformationPayment?.date}</span>
                                </span>
                            </div>
                            <div className="field col-12 md:col-6">
                            ...
                            <div className="field col-12 md:col-12">
                                ...
                                <div className="p-float-label cursor__normal mt-2">
                                    {listJobs?.length > 0 && listJobs?.map((item, index) => {
                                        return (
                                            <div key={index} className="flex flex-row w-full justify-content-between flex-wrap mt-3 mb-3">
