...
export const kpiYearOfMonth = createAsyncThunk('getKpiYearOfMonth', async (data, { rejectWithValue }) => {
	try {
		let url;
		if (data) {
...
export const jobsStaffSaler = createAsyncThunk('jobsStaffSaler', async (data, { rejectWithValue }) => {
	try {
		let url;
		if (data) {
...
export const jobsStaffEditor = createAsyncThunk('jobsStaffEditor', async (data, { rejectWithValue }) => {
	try {
		let url;
		if (data) {
